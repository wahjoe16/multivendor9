        ...
        <div class="row px-xl-5">
            <div class="col-12">
                <nav class="breadcrumb bg-light mb-30">
                    ...
                    <span class="breadcrumb-item active">{{ $getVendorShop }}</span>
                </nav>
            </div>
        </div>
    </div>
...
<div class="container-fluid">
    <div class="row px-xl-5">
        ...
        <!-- Shop Sidebar Start -->
        @include('front.products.vendor_sidebar_filter')
        <!-- Shop Sidebar End -->
                ...
                <div class="col-12">
                    <nav>
                        <ul class="pagination justify-content-center">
                            @if (isset($_GET['sort']))
                                {{-- Pagination Links --}}
                                {{ $getVendorProducts->appends(['sort' => $_GET['sort']])->links() }}
                            @else
                                {{-- Pagination Links --}}
                                {{ $getVendorProducts->links() }}
                            @endif
                        </ul>
                    </nav>
                </div>
